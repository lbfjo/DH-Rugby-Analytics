  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        {match.referee && (
          <span className="text-sm text-gray-500">Árbitro: {match.referee}</span>
        )}
      </div>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
              ...
              <p className="text-sm text-gray-500">Ruck Defensivo</p>
            </div>
            <div className="text-center p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
              <p className="text-2xl font-bold text-orange-600">
                {match.penaltiesAttackingRuck}
              </p>
              <p className="text-sm text-gray-500">Ruck Atacante</p>
            </div>
            <div className="text-center p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
              <p className="text-2xl font-bold text-yellow-600">
                {match.penaltiesOffside}
              </p>
              <p className="text-sm text-gray-500">Fora de Jogo</p>
            </div>
            <div className="text-center p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
              <p className="text-2xl font-bold text-blue-600">
                {match.penaltiesTackle}
              </p>
              <p className="text-sm text-gray-500">Placagem</p>
            </div>
          </div>
        </CardContent>
      </Card>
