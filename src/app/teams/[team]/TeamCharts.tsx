    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <PillarsRadar data={pillars} teamName={teamName} height={300} />
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <StatBar label="Placagem Sucesso" value={avgStats.tackleSuccess} />
              <StatBar label="Posse de Bola" value={avgStats.possession} />
              <StatBar label="Scrums Ganhos" value={avgStats.scrumsWon} />
              <StatBar label="Alinhamentos Ganhos" value={avgStats.lineoutsWon} />
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <TrendLineChart
            data={trendData}
            lines={[
              { dataKey: "pointsScored", name: "Pontos Marcados", color: "#16a34a" },
              { dataKey: "pointsConceded", name: "Pontos Sofridos", color: "#dc2626" },
            ]}
          />
        </CardContent>
      </Card>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <PenaltiesChart data={penaltiesData} height={300} />
          </CardContent>
        </Card>
      </div>
    </div>
